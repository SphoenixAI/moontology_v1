"""Optional LOSSY preview export; full fidelity uses prepare-humanoid-copies.py."""
import sys
if '--allow-lossy-preview' not in sys.argv:
    raise SystemExit('No files changed. This exporter reduces geometry. Pass -- --allow-lossy-preview only when explicitly wanted.')
import bpy
