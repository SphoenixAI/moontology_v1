...
export const AIRLOCK_PLACEMENT = {
  position: [-0.45, 0.95, -14.8] as const,
  rotation: [0, 0, 0] as const,
  scale: [0.45, 0.45, 0.45] as const,
};
export const APPROACH_LOCAL = new Box3(new Vector3(-2, -3, 0.7), new Vector3(2, 1, 5));
export const THRESHOLD_LOCAL = new Box3(new Vector3(-1.15, -3, -0.65), new Vector3(1.15, 1, 0.65));
