...
export const SCENE_1_STOPS = [
  ...
  { id: 'H03', title: 'Thermal check', action: 'h01-sweat', behavior: 'WIPING_BROW', taskId: 'WorkerRecovery-12',
    position: [1.8, 0, -6.5], yaw: -0.8, stop: [0.6, 0, -5.4], equipment: 'ROVER-01',
    detail: 'Wiping-brow clip · a simulated pause that requests thermal evidence.' },
  { id: 'H06', title: 'Mobility recovery', action: 'Defeat', behavior: 'SLUMPED_POSTURE', taskId: 'AssistanceCheck-19',
    position: [4.4, 0, -10.4], yaw: -0.9, stop: [3, 0, -9], equipment: 'Airlock-2A',
    detail: 'Defeat clip · a simulated recovery cue; verify drive and joint response before habitat entry.' },
] as const;
...
export const EQUIPMENT_STAGING: Record<string, { position: [number, number, number]; rotation: [number, number, number] }> = {
  'LOGISTICS-ROVER-01': { position: [8.5, 0, 1.4], rotation: [0, -0.65, 0] },
  ...
  'ROVER-01': { position: [8.3, 0, -6], rotation: [0, 0.55, 0] },
