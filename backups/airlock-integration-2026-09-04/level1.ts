  ...
  assets: [
    {
      id: 'H01',
      type: 'humanoid',
      src: '/models/humanoids/full-fidelity/Dig%20And%20Plant%20Seeds.fbx',
      position: [-7.5, 0, -3],
      rotation: [0, 0.3, 0],
      scale: [1, 1, 1],
    ...
    },
    {
      id: 'H04',
      type: 'humanoid',
      src: '/models/humanoids/full-fidelity/Writing.fbx',
      position: [3.75, 0, -3.6],
      rotation: [0, -0.25, 0],
      scale: [1, 1, 1],
    ...
    },
    {
      id: 'H02',
      type: 'humanoid',
      src: '/models/humanoids/full-fidelity/Kneeling%20Inspecting.fbx',
      position: [-3.75, 0, -3.2],
      rotation: [0, 0.15, 0],
      scale: [1, 1, 1],
    ...
    },
    {
      id: 'H05',
      type: 'humanoid',
      src: '/models/humanoids/full-fidelity/h01-kicking.fbx',
      position: [7.2, 0, -3.5],
      rotation: [0, -0.2, 0],
      scale: [1, 1, 1],
    ...
    },
    {
      id: 'H03',
      type: 'humanoid',
      src: '/models/humanoids/full-fidelity/h01-sweat.fbx',
      position: [0, 0, -3.1],
      rotation: [0, 0.28, 0],
      scale: [1, 1, 1],
    ...
    },
    {
      id: 'H06',
      type: 'humanoid',
      src: '/models/humanoids/full-fidelity/Defeat.fbx',
      position: [10.5, 0, -3.4],
      rotation: [0, -0.32, 0],
      scale: [1, 1, 1],
