...
export class AirlockController {
  ...
  private readonly tweenStart = new Vector3();
  ...
  constructor(
    ...
    this.openPosition = new Vector3().fromArray(config.openPosition);
    this.closedPosition.z = DOOR_Z;
    this.openPosition.z = DOOR_Z;
  ...
  update(deltaSeconds: number): void {
    ...
    if (
      ...
      this.doorPanel.position.lerpVectors(
        this.tweenStart,
        target,
        eased,
      );
  ...
  private enterState(state: AirlockState): void {
    this.state = state;
    this.elapsed = 0;
    this.tweenStart.copy(this.doorPanel.position);
    ...
    if (
      ...
      this.doorPanel.position.copy(this.openPosition);
    }
